...
-- Q1 (Medicine, single, medium)
insert into questions (id, subject_id, type, difficulty, stem, explanation, is_published) values
('c0000000-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 'mcq_single', 'medium',
...
-- Q2 (Medicine, single, easy)
insert into questions (id, subject_id, type, difficulty, stem, explanation, is_published) values
('c0000000-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111111', 'mcq_single', 'easy',
...
-- Q3 (Medicine, multi, hard)
insert into questions (id, subject_id, type, difficulty, stem, explanation, is_published) values
('c0000000-0000-0000-0000-000000000003', '11111111-1111-1111-1111-111111111111', 'mcq_multi', 'hard',
...
-- Q4 (Medicine, single, medium)
insert into questions (id, subject_id, type, difficulty, stem, explanation, is_published) values
('c0000000-0000-0000-0000-000000000004', '11111111-1111-1111-1111-111111111111', 'mcq_single', 'medium',
...
-- Q5 (Medicine, single, medium) — regionally relevant
insert into questions (id, subject_id, type, difficulty, stem, explanation, is_published) values
('c0000000-0000-0000-0000-000000000005', '11111111-1111-1111-1111-111111111111', 'mcq_single', 'medium',
...
-- Q6 (Medicine, single, easy) — dengue, endemic
insert into questions (id, subject_id, type, difficulty, stem, explanation, is_published) values
('c0000000-0000-0000-0000-000000000006', '11111111-1111-1111-1111-111111111111', 'mcq_single', 'easy',
...
-- Q7 (Surgery, single, medium)
insert into questions (id, subject_id, type, difficulty, stem, explanation, is_published) values
('c0000000-0000-0000-0000-000000000007', '22222222-2222-2222-2222-222222222222', 'mcq_single', 'medium',
...
-- Q8 (Surgery, multi, hard)
insert into questions (id, subject_id, type, difficulty, stem, explanation, is_published) values
('c0000000-0000-0000-0000-000000000008', '22222222-2222-2222-2222-222222222222', 'mcq_multi', 'hard',
...
-- Q9 (Surgery, single, medium)
insert into questions (id, subject_id, type, difficulty, stem, explanation, is_published) values
('c0000000-0000-0000-0000-000000000009', '22222222-2222-2222-2222-222222222222', 'mcq_single', 'medium',
...
-- Q10 (Obstetrics & Gynaecology, single, medium)
insert into questions (id, subject_id, type, difficulty, stem, explanation, is_published) values
('c0000000-0000-0000-0000-00000000000a', '33333333-3333-3333-3333-333333333333', 'mcq_single', 'medium',
...
-- Q11 (Obstetrics & Gynaecology, single, hard)
insert into questions (id, subject_id, type, difficulty, stem, explanation, is_published) values
('c0000000-0000-0000-0000-00000000000b', '33333333-3333-3333-3333-333333333333', 'mcq_single', 'hard',
...
-- Q12 (Obstetrics & Gynaecology, single, medium)
insert into questions (id, subject_id, type, difficulty, stem, explanation, is_published) values
('c0000000-0000-0000-0000-00000000000c', '33333333-3333-3333-3333-333333333333', 'mcq_single', 'medium',
...
-- Q13 (Paediatrics, single, easy)
insert into questions (id, subject_id, type, difficulty, stem, explanation, is_published) values
('c0000000-0000-0000-0000-00000000000d', '44444444-4444-4444-4444-444444444444', 'mcq_single', 'easy',
...
-- Q14 (Paediatrics, single, hard)
insert into questions (id, subject_id, type, difficulty, stem, explanation, is_published) values
('c0000000-0000-0000-0000-00000000000e', '44444444-4444-4444-4444-444444444444', 'mcq_single', 'hard',
...
-- Q15 (Paediatrics, single, medium)
insert into questions (id, subject_id, type, difficulty, stem, explanation, is_published) values
('c0000000-0000-0000-0000-00000000000f', '44444444-4444-4444-4444-444444444444', 'mcq_single', 'medium',
...
-- Q16 (Medicine, single, hard)
insert into questions (id, subject_id, type, difficulty, stem, explanation, is_published) values
('c0000000-0000-0000-0000-000000000010', '11111111-1111-1111-1111-111111111111', 'mcq_single', 'hard',
